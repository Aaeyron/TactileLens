...
abstract final class SignUpStyles {
  ...
  static const String firstNameHint =
      'Enter your first name';

  static const String lastNameLabel = 'Last name';
  static const String lastNameHint =
  ...
  static const String confirmPasswordLabel =
      'Confirm Password';
  ...
  static const String googleLabel =
      'Sign up with Google';

  static const String hasAccountLabel =
  ...
  static const String showPasswordTooltip =
      'Show password';

  static const String hidePasswordTooltip =
      'Hide password';
  ...
  static const String emailExistsMessage =
  ...
  static const Color fieldSuffixIconColor =
      Color(0xFF7F8EAE);
  ...
  static const Color selectedRoleIconBackground =
      Color(0xFFDCEAFF);

  static const Color unselectedRoleIconBackground =
      Color(0xFFE7F8EE);
  ...
  static const Color decorationDotColor =
      Color(0xFFDCEAFF);

  static const Color illustrationColor =
      Color(0xFF78A9FF);
  ...
  static const IconData personIcon =
  ...
  static const IconData visiblePasswordIcon =
      Icons.visibility_outlined;

  static const IconData hiddenPasswordIcon =
      Icons.visibility_off_outlined;

  static const IconData studentIcon =
      Icons.school_outlined;

  static const IconData educatorIcon =
  ...
  static const IconData illustrationIcon =
  ...
  static const TextStyle descriptionHighlightStyle =
      TextStyle(
        color: brightPrimaryColor,
  ...
  static const TextStyle googleButtonTextStyle =
      TextStyle(
        color: darkTitleColor,
        fontSize: 14,
        fontWeight: FontWeight.w700,
  ...
  static const OutlineInputBorder enabledFieldBorder =
      OutlineInputBorder(
  ...
  static const OutlineInputBorder focusedFieldBorder =
      OutlineInputBorder(
        borderRadius: fieldRadius,
        borderSide: BorderSide(
          color: brightPrimaryColor,
  ...
  static const OutlineInputBorder disabledFieldBorder =
      OutlineInputBorder(
        borderRadius: fieldRadius,
        borderSide: BorderSide(
          color: dividerColor,
  ...
  static const InputDecoration firstNameDecoration =
      InputDecoration(
  ...
  static const InputDecoration lastNameDecoration =
      InputDecoration(
  ...
  static const InputDecoration emailDecoration =
      InputDecoration(
        hintText: emailHint,
        hintStyle: TextStyle(
          color: fieldHintColor,
  ...
  static const InputDecoration passwordDecoration =
      InputDecoration(
  ...
  confirmPasswordDecoration = InputDecoration(
  ...
  static final ButtonStyle signUpButtonStyle =
      ElevatedButton.styleFrom(
        backgroundColor: brightPrimaryColor,
        foregroundColor: surfaceColor,
        disabledBackgroundColor:
            brightPrimaryColor.withValues(alpha: 0.55),
  ...
  static final ButtonStyle googleButtonStyle =
  ...
  static final ButtonStyle signInLinkButtonStyle =
  ...
  static const EdgeInsets orLabelPadding =
  ...
  backgroundDecorationGradient = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: <Color>[
      Color(0xFFDDEAFF),
  ...
  static const List<BoxShadow> decorationDotShadow =
      <BoxShadow>[
        BoxShadow(
          color: Color(0x1F1769E8),
          blurRadius: 4,
          offset: Offset(0, 2),
        ),
      ];
